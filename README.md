...
1. Veillez cliquer sur **[Fork](https://github.com/gbevon/Zokou-2.0/fork)** afin de copier le repo sur votre compte github.  veillez bien ajouter une etoile 🌟 pour encourager les développeurs 
...
- **déploiement sur heroku**
  ...
  2.  cliquez [**ici**](https://dashboard.heroku.com/new?template=https://github.com/LOA/Zokou-2.0) pour deployer le bot sur **heroku**
...
## Developpeur :
  ...
  [**LOA**](https://github.com/LOA/Zokou-MD/)  <br>
